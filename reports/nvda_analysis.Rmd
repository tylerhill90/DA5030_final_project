---
title: "NVDA univariate forecasting analysis"
author: "Tyler Hill"
date: "5/3/2022"
...
**Note:** the highchart theme `thm` I am using is defined in `../setup.R`.
...
for(i in 0:(nrow(split_data$test)-n_days)) {
  ...
  if(i == 0) {
    xi <- split_data$og_train[(length(split_data$og_validate)-trans_ts$lag):length(split_data$og_validate)]
  } else {
    xi <- split_data$og_test[i:(i+trans_ts$lag)]
  }
